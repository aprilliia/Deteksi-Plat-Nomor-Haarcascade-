...
plateCascade = cv2.CascadeClassifier("C:\\SC\\DeteksiPlatNomor-main\\haarcascade_russian_plate_number.xml")
...
while True:
    ...
    if k%256 == 27:
        ...
        cv2.imwrite("C:\SC\DeteksiPlatNomor-main\Data\data"+str(count)+".jpg", imgRoi)
